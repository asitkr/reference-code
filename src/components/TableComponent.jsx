...
const TableComponent = ({ data }) => {
    ...
    return (
        <div className="overflow-x-auto bg-white rounded-lg shadow-md relative">
            ...
            <div className="absolute top-36 -right-12 w-24 h-24 bg-transparent rounded-xl shadow-inner shadow-yellow-800" />
            <div className="absolute bottom-44 right-14 w-24 h-24 bg-transparent rounded-xl shadow-inner shadow-red-800" />
            <div className="absolute top-40 right-1/3 w-24 h-24 bg-transparent rounded-xl shadow-inner shadow-sky-800" />
            <div className="absolute top-12 right-12 w-12 h-12 bg-transparent rounded-xl shadow-inner shadow-red-800" />
            <div className="absolute top-40 left-96 w-44 h-44 bg-transparent rounded-xl shadow-inner shadow-green-800" />
            <div className="absolute top-24 -left-12 w-60 h-60 bg-transparent rounded-xl shadow-inner shadow-sky-800" />
            <div className="absolute bottom-24 left-12 w-4 h-4 bg-transparent rounded-xl shadow-inner shadow-sky-500" />
            <div className="absolute top-24 right-1/2 w-4 h-4 bg-transparent rounded-xl shadow-inner shadow-yellow-500" />
